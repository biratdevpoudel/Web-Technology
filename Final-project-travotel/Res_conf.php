    		...
    		if(isset($_GET['save2']))	
			{
			    ...
			    if($flag2==0 && $flag == 0)
			    {
			    	...
			    	$user = $_SESSION['user1'];
			      	...
			      	$q3 = "insert into reservation(hid,roomtype,username,no_rooms,no_guests,in_date,out_date,amount,status,approval) values ('$hid','$rtname','$user','$no_rooms','$guests','$checkin','$checkout','$amount','Not Confirmed','Not Approved')";
			      	mysqli_query($db,$q3);
