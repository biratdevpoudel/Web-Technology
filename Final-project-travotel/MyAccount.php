...
<body>
    ...
    <div class="content3"><!--Division for My Bookings-->
    	...
    	<div class="content2"><!--To be looped-->
    		<?php
    			$q2 = "select * from reservation where username = '$user' AND status !='Cancelled'";
    			...
    			while($row2 = mysqli_fetch_array($res2))
    			{
    				if(strcmp($row2['status'],"Confirmed")==0 || strcmp($row2['status'],"Cancelled")==0)
	    			{
    					...
    					echo '<h4 style="font-size: 150%">'.$row3['hname'].'<span class="tab2">'.($row2['approval']=='Not Approved'?'Waiting For approval':'Approved').'</span><br></h4>
