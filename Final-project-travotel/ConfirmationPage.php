...
<body>
    ...
    <div class="content2">
    	<p>Thank You for using Book Your Hotel Hotels to book your Hotel Accomodation.</p>
    	<p>Kindly Note, that your Booking is awaiting for <b>Approval</b> and you are not required to contact the hotel or Book Your Hotel Hotels to reconfirm the same.</p>
    	...
    	<p>Team Book Your Hotel Hotels</p>
    </div><br>
